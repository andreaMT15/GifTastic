...
When the user clicks a button, it will load memes to the page along with the rating (I.E. G, PG-13). When the user clicks the image with will turn into an animated GIF version of the meme. If the user clicks the image again, the animation will stop. 
